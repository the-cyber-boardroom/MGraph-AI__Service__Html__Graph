...
class test_Html_Use_Case__2(TestCase):
    ...
    def test_html_mgraph__simple_bold(self):                                                    # Test parent lookup
        with self.html_mgraph__simple_bold as _:
            ...
            assert _.mgraph.index().index_data.obj() == __(edges_by_path                   = __( _0 = ['e0000003'] ),
                                                           ...
                                                           edges_predicates                = __()                                     ,
                                                           edges_to_nodes                  = __( e0000003 = ['c0000001', 'c0000003'] ),
                                                           edges_types                     = __( e0000003 = 'Schema__MGraph__Edge' ),
                                                           nodes_by_path                   = __( div  = ['c0000001'],
                                                                                                 text = ['c0000003'] ),
                                                           ...
                                                           nodes_to_outgoing_edges         = __( c0000001 = ['e0000003'],
                                                                                                 c0000003 = [] ),
                                                           nodes_to_outgoing_edges_by_type = __( c0000001 = __( Schema__MGraph__Edge = ['e0000003'] )),
    ...
    def test_html_mgraph__mixed_content(self):
        with self.html_mgraph__mixed_content as _:
            ...
            assert _.mgraph.index().index_data.obj() == __(edges_by_path=__(_0=['e0000006']),
                                                           edges_by_predicate=__(),
                                                           edges_by_incoming_label=__(),
                                                           edges_by_outgoing_label=__(),
                                                           edges_incoming_labels    =__(),
                                                           ...
                                                           edges_predicates=__(),
                                                           edges_to_nodes=__(e0000006=['c0000001', 'c0000006']),
                                                           edges_types=__(e0000006='Schema__MGraph__Edge'),
                                                           nodes_by_path=__(div=['c0000001'], text=['c0000006']),
                                                           nodes_by_type=__(Schema__MGraph__Node=['c0000001'],
                                                           ...
                                                           nodes_to_outgoing_edges_by_type=__(c0000001=__(Schema__MGraph__Edge=['e0000006'])),
                                                           nodes_types=__(c0000001='Schema__MGraph__Node',
                                                                          c0000006='Schema__MGraph__Node__Value')) != __()
    ...
    def test_html_mgraph__multiple_tags(self):
        with self.html_mgraph__multiple_tags as _:
            ...
            assert _.mgraph.index().index_data.obj() != __()
            assert _.mgraph.index().index_data.obj()  == __(edges_by_path                    = __( _0 = ['e0000010'] ),
                                                            edges_by_predicate              = __(),
                                                            edges_by_incoming_label         = __(),
                                                            edges_by_outgoing_label         = __(),
                                                            ...
                                                            edges_outgoing_labels           = __(),
                                                            edges_predicates                = __(),
                                                            edges_to_nodes                  = __( e0000010 = ['c0000001', 'c0000009'] ),
                                                            ...
                                                            nodes_to_outgoing_edges         = __( c0000001 = ['e0000010'],
                                                                                                  c0000009 = [] ),
    ...
    def test_html_mgraph__nested_structure(self):
        with self.html_mgraph__nested_structure as _:
            ...
            assert _.mgraph.index().index_data.obj() == __(edges_by_path                    = __( _0 = ['e0000008', 'e0000014', 'e0000018', 'e0000019'],
                                                                                                   _1 = ['e0000013'] ),
                                                            edges_by_predicate              = __(),
                                                            edges_by_incoming_label         = __(),
                                                            edges_by_outgoing_label         = __(),
                                                            ...
                                                            edges_outgoing_labels           = __(),
                                                            edges_predicates                = __(),
                                                            edges_to_nodes                  = __( e0000008 = ['c0000002', 'c0000003'],
                                                            ...
                                                            nodes_by_path                   = __( html               = ['c0000001'],
                                                                                                  html_body          = ['c0000002'],
                                                            ...
                                                            nodes_by_type                   = __( Schema__MGraph__Node       = ['c0000001',
                                                                                                                            ...
                                                                                                                            'c0000003',
                                                                                                                            'c0000011'],
                                                                                                  Schema__MGraph__Node__Value = ['c0000016', 'c0000017'] ),
                                                            nodes_to_incoming_edges         = __( c0000001 = [],
                                                                                                  c0000002 = ['e0000014'],
                                                                                                  c0000003 = ['e0000008'],
                                                                                                  c0000011 = ['e0000013'],
                                                            ...
                                                            nodes_to_outgoing_edges         = __( c0000001 = ['e0000014'],
                                                                                                  ...
                                                                                                  c0000016 = [],
                                                                                                  c0000017 = [] ),
                                                            nodes_to_outgoing_edges_by_type = __( c0000002 = __( Schema__MGraph__Edge = ['e0000008', 'e0000013'] ),
