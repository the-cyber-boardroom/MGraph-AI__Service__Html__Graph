...
from mgraph_ai_service_html__graph.service.info.Service_Info                     import Service_Info
from mgraph_ai_service_html__graph.service.info.schemas.Enum__Service_Status     import Enum__Service_Status
from mgraph_ai_service_html__graph.service.info.schemas.Schema__Service__Status  import Schema__Service__Status
...
class test_Server_Info(TestCase):
    ...
    def test_status(self):
        with self.server_info.service_info() as _:
            ...
            assert _.name        == 'mgraph_ai_service_html__graph'
            assert _.status      == Enum__Service_Status.operational
            assert _.version     == version__mgraph_ai_service_html__graph
