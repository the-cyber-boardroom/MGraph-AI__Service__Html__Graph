...
class LETS_Pipeline__Full:
    ...
    def process_url(self, url: Safe_Str__Url) -> dict:
        ...
        # ─────────────────────────────────────────────────────────────────────
        # L4: Convert MGraph back to HTML (round-trip)
        # ─────────────────────────────────────────────────────────────────────
        try:
            if document:
...
class test_integration__Full_LETS_Pipeline(TestCase):
    ...
    #     if result['L0']['data']:
    #         print(f"  Status:         {result['L0']['data'].status_code    }")
    #         print(f"  Content-Type:   {result['L0']['data'].content_type   }")
    #         print(f"  Fetch Duration: {result['L0']['data'].fetch_duration }ms")
    #
    #     print(f"\nL1 (Raw HTML):")
