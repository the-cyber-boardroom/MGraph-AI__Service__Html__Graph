...
class Schema__Phase_E__Process_Result(Type_Safe):                                                # Full result with intermediate data
    ...
    text_nodes       : Dict[Node_Id, Schema__Phase_E__Text_Node_Info]                                  # Extracted text nodes
    merged_texts     : Dict[Node_Id, Schema__Phase_E__Merged_Text_Info]                                # Virtual merge results
    decisions        : Dict[Node_Id, Schema__Phase_E__Decision_Result]                                # Decision results
    parents_deleted  : List[Node_Id]                                                # Deleted parent_ids
